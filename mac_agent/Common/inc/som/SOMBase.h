#ifndef SOM_BASE_H_INCLUDED
#define SOM_BASE_H_INCLUDED
...
const long ERROR_GEN_FAILURE = -1;
...
public:
	...
	DataItem * GetItem (unsigned long ItemIndex) 
	{
...
public:
	...
	long AddNVItem( const char * ItemName, const char * ItemValue)
	{
